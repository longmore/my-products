...
$(document).ready(function(){
	 ...
	 document.getElementById("main_visual").style.height = parseInt(main_visual_width)+"px";
	 document.getElementById("main_image").style.height = parseInt(main_visual_width)+"px";
	fn();
